...
// Appraoch - (Using cumulative sum + game strategy)
...
class Solution {
    public long gridGame(int[][] grid) {
        ...
        for(int Robot1Col = 0; Robot1Col<grid[0].length ; Robot1Col++){
            ...
            long bestOffRobot2 = Math.max(firstRowRemainSum, secondRowRemainSum);

            minimizedRobot2Sum = Math.min(minimizedRobot2Sum, bestOffRobot2);
